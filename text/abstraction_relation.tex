...
A path condition is a three-tuple $\big\langle \mathit{Input}$, $\mathit{Output}$, $\mathit{trace}\big\rangle$, where:
...
The empty path condition is defined as $\{\emptyset, \emptyset, \emptyset \}$.
